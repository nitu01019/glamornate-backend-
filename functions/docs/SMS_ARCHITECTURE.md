...
- [ ] Replace Twilio tombstone at `notifications.ts:9` with: `// SMS via MSG91 Firebase Extension (msg91/msg91-send-msg) — writes to 'sms_dispatch' Firestore collection. See backend/functions/docs/SMS_ARCHITECTURE.md`
...
> Evidence basis: `backend/functions/docs/FIREBASE_SMS_RESEARCH.md` (firebase-master, 2026-04-27)
